...
// NO-TE: This is an experimental API. We are still investigating
...
$.extend(Datepicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		$.datepicker._updateDatepicker(inst);
		// fi-x width for dynamic number of date pickers
		...
		$.each( draggable.sortables, function() {
			...
			if ( innermostIntersecting ) {
				...
				if ( !sortable.isOver ) {
					...
					// ha-ck so receive/update callbacks work (mostly)
	...
	_createRange: function() {
		...
		if ( options.range ) {
			...
			if ( !this.range || !this.range.length ) {
				...
				// no-te: this isn't the most fittingly semantic framework class for this element,
...
var sortable = $.widget("ui.sortable", $.ui.mouse, {
	...
	_clear: function(event, noPropagation) {
		...
		// No-te: don't do it if the current item is already removed (by a user), or it gets reappended (see #4088)
...
var spinner = $.widget( "ui.spinner", {
	...
	_adjustValue: function( value ) {
		...
		// fi-x precision from bad JS floating point math
